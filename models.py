...
class RSM1D(nn.Module):
    def __init__(self, channels_in=None, channels_out=None):
        ...
        # self.conv4 = nn.Conv1d(in_channels=channels_out, out_channels=channels_out, bias=False, kernel_size=3, padding=1)
        # self.conv5 = nn.Conv1d(in_channels=channels_out, out_channels=channels_out, bias=False, kernel_size=3, padding=1)
        ...
        # self.bn5 = nn.BatchNorm1d(channels_out)
